...
class WebKitFeatureStatusTest(unittest.TestCase):
    ...
    def openpage(self):
        print("opening local page")
        self.driver.get("file:///Users/ken/Dropbox/shared/src/script/smd/tests/sos/html/vars.html")
        print("returning from open local page")
        time.sleep(5)
    def test_feature_status_page_search(self):
        print("open webkit.org/status/")
...
if __name__ == "__main__":
    x=WebKitFeatureStatusTest()
    x.test_feature_status_page_search()
    x.openpage()
    x.driver.quit()
