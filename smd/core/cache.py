...
class ImportCache(object):
    def __init__(self):
        ...
        self._importCache += ConfigFile("import/def_body.md", _tls_data.sd.load_default_body).filenameAsList()
        self._importCache += ConfigFile("import/def_head.md", _tls_data.sd.load_default_head).filenameAsList()
        self._importCache += ConfigFile("import/def_html.md", _tls_data.sd.load_default_html).filenameAsList()
        ...
        self._importCache += LocalUserConfigFile("import/builtins.md", _tls_data.sd.load_user_builtins).filenameAsList()
        self._importCache += ConfigFile("import/builtins.md", _tls_data.sd.load_default_builtins, user_ver=False).filenameAsList()
